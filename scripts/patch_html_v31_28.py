...
old_title_renderer = '''    function renderAbilityTitleScopedTags(ability, tagContext = null) {
...
replace_once(old_title_renderer, new_title_renderer, 'disable title-cell scoped Tags')
